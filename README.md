...
So SSD Linker is a GUI tool for easy managing cross-drive (ssd and hdd) links.
And is suitable for next applications:
...
Once you are done with particular game you unlink it, so it will move data back to original driver and delete symlinks.
